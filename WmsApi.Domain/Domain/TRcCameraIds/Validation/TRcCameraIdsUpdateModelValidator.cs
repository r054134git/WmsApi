...
{
    /// <summary>
    /// Validator class for <see cref="TRcCameraIdsUpdateModel"/> .
    /// </summary>
    public partial class TRcCameraIdsUpdateModelValidator
        : AbstractValidator<TRcCameraIdsUpdateModel>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TRcCameraIdsUpdateModelValidator"/> class.
        /// </summary>
        public TRcCameraIdsUpdateModelValidator()
        {
