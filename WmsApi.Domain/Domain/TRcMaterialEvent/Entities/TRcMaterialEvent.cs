...
{
    /// <summary>
    /// Entity class representing data for table 't_rc_material_event'.
    /// </summary>
    public partial class TRcMaterialEvent
        : IHaveIdentifier
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TRcMaterialEvent"/> class.
        /// 物料事件记录表
        /// </summary>
        public TRcMaterialEvent()
        {
