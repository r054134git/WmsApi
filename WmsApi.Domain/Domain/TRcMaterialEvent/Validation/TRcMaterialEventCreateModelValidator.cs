...
{
    /// <summary>
    /// Validator class for <see cref="TRcMaterialEventCreateModel"/> .
    /// </summary>
    public partial class TRcMaterialEventCreateModelValidator
        : AbstractValidator<TRcMaterialEventCreateModel>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TRcMaterialEventCreateModelValidator"/> class.
        /// </summary>
        public TRcMaterialEventCreateModelValidator()
        {
