...
{
    /// <summary>
    /// Validator class for <see cref="TRcMaterialEventUpdateModel"/> .
    /// </summary>
    public partial class TRcMaterialEventUpdateModelValidator
        : AbstractValidator<TRcMaterialEventUpdateModel>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TRcMaterialEventUpdateModelValidator"/> class.
        /// </summary>
        public TRcMaterialEventUpdateModelValidator()
        {
