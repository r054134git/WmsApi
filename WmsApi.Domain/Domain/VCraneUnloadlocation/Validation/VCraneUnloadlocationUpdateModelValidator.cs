...
{
    /// <summary>
    /// Validator class for <see cref="VCraneUnloadlocationUpdateModel"/> .
    /// </summary>
    public partial class VCraneUnloadlocationUpdateModelValidator
        : AbstractValidator<VCraneUnloadlocationUpdateModel>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="VCraneUnloadlocationUpdateModelValidator"/> class.
        /// </summary>
        public VCraneUnloadlocationUpdateModelValidator()
        {
