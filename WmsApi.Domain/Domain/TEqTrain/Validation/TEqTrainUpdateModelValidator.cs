...
{
    /// <summary>
    /// Validator class for <see cref="TEqTrainUpdateModel"/> .
    /// </summary>
    public partial class TEqTrainUpdateModelValidator
        : AbstractValidator<TEqTrainUpdateModel>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TEqTrainUpdateModelValidator"/> class.
        /// </summary>
        public TEqTrainUpdateModelValidator()
        {
