...
{
    /// <summary>
    /// Entity class representing data for table 't_pl_truck_load_list_detail'.
    /// </summary>
    public partial class TPlTruckLoadListDetail
        : IHaveIdentifier
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TPlTruckLoadListDetail"/> class.
        /// 汽车发货通知单明细
        /// </summary>
        public TPlTruckLoadListDetail()
        {
