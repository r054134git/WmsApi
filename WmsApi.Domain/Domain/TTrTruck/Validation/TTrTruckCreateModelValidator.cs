...
{
    /// <summary>
    /// Validator class for <see cref="TTrTruckCreateModel"/> .
    /// </summary>
    public partial class TTrTruckCreateModelValidator
        : AbstractValidator<TTrTruckCreateModel>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TTrTruckCreateModelValidator"/> class.
        /// </summary>
        public TTrTruckCreateModelValidator()
        {
