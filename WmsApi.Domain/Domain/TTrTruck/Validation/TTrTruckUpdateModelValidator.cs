...
{
    /// <summary>
    /// Validator class for <see cref="TTrTruckUpdateModel"/> .
    /// </summary>
    public partial class TTrTruckUpdateModelValidator
        : AbstractValidator<TTrTruckUpdateModel>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TTrTruckUpdateModelValidator"/> class.
        /// </summary>
        public TTrTruckUpdateModelValidator()
        {
