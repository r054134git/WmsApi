...
{
    /// <summary>
    /// Validator class for <see cref="VMaterialEventUpdateModel"/> .
    /// </summary>
    public partial class VMaterialEventUpdateModelValidator
        : AbstractValidator<VMaterialEventUpdateModel>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="VMaterialEventUpdateModelValidator"/> class.
        /// </summary>
        public VMaterialEventUpdateModelValidator()
        {
