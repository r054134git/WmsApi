...
{
    /// <summary>
    /// Validator class for <see cref="VMaterialEventCreateModel"/> .
    /// </summary>
    public partial class VMaterialEventCreateModelValidator
        : AbstractValidator<VMaterialEventCreateModel>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="VMaterialEventCreateModelValidator"/> class.
        /// </summary>
        public VMaterialEventCreateModelValidator()
        {
