...
{
    /// <summary>
    /// Validator class for <see cref="VMaterialEventReportCreateModel"/> .
    /// </summary>
    public partial class VMaterialEventReportCreateModelValidator
        : AbstractValidator<VMaterialEventReportCreateModel>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="VMaterialEventReportCreateModelValidator"/> class.
        /// </summary>
        public VMaterialEventReportCreateModelValidator()
        {
