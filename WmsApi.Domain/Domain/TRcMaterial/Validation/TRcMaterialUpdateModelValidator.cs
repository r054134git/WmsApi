...
{
    /// <summary>
    /// Validator class for <see cref="TRcMaterialUpdateModel"/> .
    /// </summary>
    public partial class TRcMaterialUpdateModelValidator
        : AbstractValidator<TRcMaterialUpdateModel>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TRcMaterialUpdateModelValidator"/> class.
        /// </summary>
        public TRcMaterialUpdateModelValidator()
        {
