...
{
    /// <summary>
    /// Entity class representing data for table 't_rc_material_event_migrate'.
    /// </summary>
    public partial class TRcMaterialEventMigrate
        : IHaveIdentifier
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TRcMaterialEventMigrate"/> class.
        /// t_rc_material_event 数据迁移表
        /// </summary>
        public TRcMaterialEventMigrate()
        {
