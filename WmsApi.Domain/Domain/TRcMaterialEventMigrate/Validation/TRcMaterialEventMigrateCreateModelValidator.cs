...
{
    /// <summary>
    /// Validator class for <see cref="TRcMaterialEventMigrateCreateModel"/> .
    /// </summary>
    public partial class TRcMaterialEventMigrateCreateModelValidator
        : AbstractValidator<TRcMaterialEventMigrateCreateModel>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TRcMaterialEventMigrateCreateModelValidator"/> class.
        /// </summary>
        public TRcMaterialEventMigrateCreateModelValidator()
        {
