...
{
    /// <summary>
    /// Validator class for <see cref="VCompareNameNoUpdateModel"/> .
    /// </summary>
    public partial class VCompareNameNoUpdateModelValidator
        : AbstractValidator<VCompareNameNoUpdateModel>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="VCompareNameNoUpdateModelValidator"/> class.
        /// </summary>
        public VCompareNameNoUpdateModelValidator()
        {
