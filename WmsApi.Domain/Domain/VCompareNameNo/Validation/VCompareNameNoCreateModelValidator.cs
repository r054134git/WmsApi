...
{
    /// <summary>
    /// Validator class for <see cref="VCompareNameNoCreateModel"/> .
    /// </summary>
    public partial class VCompareNameNoCreateModelValidator
        : AbstractValidator<VCompareNameNoCreateModel>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="VCompareNameNoCreateModelValidator"/> class.
        /// </summary>
        public VCompareNameNoCreateModelValidator()
        {
