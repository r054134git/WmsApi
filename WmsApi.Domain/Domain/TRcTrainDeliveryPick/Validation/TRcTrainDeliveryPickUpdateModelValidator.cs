...
{
    /// <summary>
    /// Validator class for <see cref="TRcTrainDeliveryPickUpdateModel"/> .
    /// </summary>
    public partial class TRcTrainDeliveryPickUpdateModelValidator
        : AbstractValidator<TRcTrainDeliveryPickUpdateModel>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TRcTrainDeliveryPickUpdateModelValidator"/> class.
        /// </summary>
        public TRcTrainDeliveryPickUpdateModelValidator()
        {
