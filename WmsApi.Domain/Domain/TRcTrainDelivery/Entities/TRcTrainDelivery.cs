...
{
    /// <summary>
    /// Entity class representing data for table 't_rc_train_delivery'.
    /// </summary>
    public partial class TRcTrainDelivery
        : IHaveIdentifier
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TRcTrainDelivery"/> class.
        /// 
        /// </summary>
        public TRcTrainDelivery()
        {
