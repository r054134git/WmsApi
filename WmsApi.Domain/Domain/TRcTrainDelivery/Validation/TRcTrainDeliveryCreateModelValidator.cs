...
{
    /// <summary>
    /// Validator class for <see cref="TRcTrainDeliveryCreateModel"/> .
    /// </summary>
    public partial class TRcTrainDeliveryCreateModelValidator
        : AbstractValidator<TRcTrainDeliveryCreateModel>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TRcTrainDeliveryCreateModelValidator"/> class.
        /// </summary>
        public TRcTrainDeliveryCreateModelValidator()
        {
