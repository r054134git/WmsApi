...
{
    /// <summary>
    /// Validator class for <see cref="TPlBayCreateModel"/> .
    /// </summary>
    public partial class TPlBayCreateModelValidator
        : AbstractValidator<TPlBayCreateModel>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TPlBayCreateModelValidator"/> class.
        /// </summary>
        public TPlBayCreateModelValidator()
        {
