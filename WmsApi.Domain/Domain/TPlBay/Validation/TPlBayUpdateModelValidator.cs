...
{
    /// <summary>
    /// Validator class for <see cref="TPlBayUpdateModel"/> .
    /// </summary>
    public partial class TPlBayUpdateModelValidator
        : AbstractValidator<TPlBayUpdateModel>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TPlBayUpdateModelValidator"/> class.
        /// </summary>
        public TPlBayUpdateModelValidator()
        {
            ...
            RuleFor(p => p.TruckNo).MaximumLength(255);
            #endregion
        }
