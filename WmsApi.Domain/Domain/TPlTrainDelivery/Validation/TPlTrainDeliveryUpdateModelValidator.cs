...
{
    /// <summary>
    /// Validator class for <see cref="TPlTrainDeliveryUpdateModel"/> .
    /// </summary>
    public partial class TPlTrainDeliveryUpdateModelValidator
        : AbstractValidator<TPlTrainDeliveryUpdateModel>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TPlTrainDeliveryUpdateModelValidator"/> class.
        /// </summary>
        public TPlTrainDeliveryUpdateModelValidator()
        {
