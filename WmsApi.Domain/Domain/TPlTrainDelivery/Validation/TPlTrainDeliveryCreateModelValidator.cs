...
{
    /// <summary>
    /// Validator class for <see cref="TPlTrainDeliveryCreateModel"/> .
    /// </summary>
    public partial class TPlTrainDeliveryCreateModelValidator
        : AbstractValidator<TPlTrainDeliveryCreateModel>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TPlTrainDeliveryCreateModelValidator"/> class.
        /// </summary>
        public TPlTrainDeliveryCreateModelValidator()
        {
