...
{
    /// <summary>
    /// Entity class representing data for table 't_pl_train_delivery'.
    /// </summary>
    public partial class TPlTrainDelivery
        : IHaveIdentifier
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TPlTrainDelivery"/> class.
        /// 火车发货日计划表
        /// </summary>
        public TPlTrainDelivery()
        {
