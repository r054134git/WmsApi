...
{
    /// <summary>
    /// Validator class for <see cref="TTrMessageSendCreateModel"/> .
    /// </summary>
    public partial class TTrMessageSendCreateModelValidator
        : AbstractValidator<TTrMessageSendCreateModel>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TTrMessageSendCreateModelValidator"/> class.
        /// </summary>
        public TTrMessageSendCreateModelValidator()
        {
