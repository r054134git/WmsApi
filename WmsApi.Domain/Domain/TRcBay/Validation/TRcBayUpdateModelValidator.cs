...
{
    /// <summary>
    /// Validator class for <see cref="TRcBayUpdateModel"/> .
    /// </summary>
    public partial class TRcBayUpdateModelValidator
        : AbstractValidator<TRcBayUpdateModel>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TRcBayUpdateModelValidator"/> class.
        /// </summary>
        public TRcBayUpdateModelValidator()
        {
