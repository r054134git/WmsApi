...
{
    /// <summary>
    /// Validator class for <see cref="TRlCranePlanTypeUpdateModel"/> .
    /// </summary>
    public partial class TRlCranePlanTypeUpdateModelValidator
        : AbstractValidator<TRlCranePlanTypeUpdateModel>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TRlCranePlanTypeUpdateModelValidator"/> class.
        /// </summary>
        public TRlCranePlanTypeUpdateModelValidator()
        {
