...
{
    /// <summary>
    /// Validator class for <see cref="TPlCraneTaskUpdateModel"/> .
    /// </summary>
    public partial class TPlCraneTaskUpdateModelValidator
        : AbstractValidator<TPlCraneTaskUpdateModel>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TPlCraneTaskUpdateModelValidator"/> class.
        /// </summary>
        public TPlCraneTaskUpdateModelValidator()
        {
