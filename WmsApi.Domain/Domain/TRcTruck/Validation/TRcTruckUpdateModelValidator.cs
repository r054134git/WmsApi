...
{
    /// <summary>
    /// Validator class for <see cref="TRcTruckUpdateModel"/> .
    /// </summary>
    public partial class TRcTruckUpdateModelValidator
        : AbstractValidator<TRcTruckUpdateModel>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TRcTruckUpdateModelValidator"/> class.
        /// </summary>
        public TRcTruckUpdateModelValidator()
        {
