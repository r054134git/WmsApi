...
{
    /// <summary>
    /// Entity class representing data for table 't_wh_crane_passage'.
    /// </summary>
    public partial class TWhCranePassage
        : IHaveIdentifier
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TWhCranePassage"/> class.
        /// 行车穿行汽车通道的专属通道
        /// </summary>
        public TWhCranePassage()
        {
