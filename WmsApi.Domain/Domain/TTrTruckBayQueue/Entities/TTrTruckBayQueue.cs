...
{
    /// <summary>
    /// Entity class representing data for table 't_tr_truck_bay_queue'.
    /// </summary>
    public partial class TTrTruckBayQueue
        : IHaveIdentifier
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TTrTruckBayQueue"/> class.
        /// 汽车排队信息
        /// </summary>
        public TTrTruckBayQueue()
        {
