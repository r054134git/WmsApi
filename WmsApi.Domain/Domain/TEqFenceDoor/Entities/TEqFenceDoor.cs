...
{
    /// <summary>
    /// Entity class representing data for table 't_eq_fence_door'.
    /// </summary>
    public partial class TEqFenceDoor
        : IHaveIdentifier
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TEqFenceDoor"/> class.
        /// 库区围栏的安全门参数
        /// </summary>
        public TEqFenceDoor()
        {
        ...
        public virtual TEqFenceArea OwnerTEqFenceArea { get; set; }
