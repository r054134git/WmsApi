...
{
    /// <summary>
    /// Validator class for <see cref="TRcCraneTaskUpdateModel"/> .
    /// </summary>
    public partial class TRcCraneTaskUpdateModelValidator
        : AbstractValidator<TRcCraneTaskUpdateModel>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TRcCraneTaskUpdateModelValidator"/> class.
        /// </summary>
        public TRcCraneTaskUpdateModelValidator()
        {
