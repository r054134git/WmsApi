...
{
    /// <summary>
    /// Entity class representing data for table 't_rc_crane_task'.
    /// </summary>
    public partial class TRcCraneTask
        : IHaveIdentifier
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TRcCraneTask"/> class.
        /// 行车吊运任务计划表
        /// </summary>
        public TRcCraneTask()
        {
