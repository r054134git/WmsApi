...
namespace WmsApi.Contracts.Models
{
    ...
    /// 汽车装车清单
    /// </summary>
    public partial class TPlTruckLoadListReadModel
        : EntityReadModel
    {
        ...
        #endregion
        public string TruckLoadListNo { get; set; }
        public string LoadListSourceHouse { get; set; }
        ...
        public string DeliveryTypeDesc
        {
            get
            {
                if (DeliveryOrderNo.StartsWith("F"))
                    return "发货单";
                else if (DeliveryOrderNo.StartsWith("B") || DeliveryOrderNo.StartsWith("W"))
                    return "移库单";
                return "未知";
            }
        }
        public string ResolveStateDesc
        {
            get
            {
                if (ResolveState == 1)
